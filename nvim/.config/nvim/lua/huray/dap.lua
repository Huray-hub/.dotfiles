...
dap.configurations.cpp = {
	{
		...
		type = "cppdbg",
		request = "launch",
    program = "/home/pskiadas/Repos/competitive-programming/a.out",
		-- program = function()
		-- 	return vim.fn.input("Path to executable: ", vim.fn.getcwd() .. "/", "file")
		-- end,

		cwd = "${workspaceFolder}/Repos/competitive-programming/",
    args = {'<','input1.txt'},
		stopOnEntry = true,
		setupCommands = {
			{
...
keymap("n", "<F22>", "<cmd>lua require('dap').step_out()<CR>", opts) --TODO: test that behaves like S-F11
